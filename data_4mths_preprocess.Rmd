---
title: "Long Covid study scRNA-seq, 4 month time point, data preprocessing"
...
This specific script reads in the libraries from samples collected at 4 months post-infection.

The GSM8180643_1_4mths library (pool 1, replicate 1) has a corrupted data file in the 10X data and I cannot read it in, so unfortunately, this object will only have two libraries. There is no pool 1, replicate 2 at all; therefore, this combined object has only 10 patients (5 long COVID, 5 matched controls) with the two technical replicates.
...
saveRDS(combo, "./data/covid/initial_combo_4mths.rds")
```
